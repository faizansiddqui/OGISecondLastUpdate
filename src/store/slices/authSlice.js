...
import { auth as firebaseAuth, firestore } from '../../firebaseConfig'; // Rename this import to avoid conflict
import { doc, setDoc } from 'firebase/firestore';

// Initialize Firebase auth
const auth = getAuth(); // Local auth instance from firebase/auth
    ...
    return new Promise((resolve, reject) => {
      onAuthStateChanged(auth, (user) => {
        if(user){
          ...
          reject(rejectWithValue('User not signed in'));
        }
      });
    });
  }
